...
In the following Dockerfile, replace \<YOUR_GIT_REPO_URL> with the url of your Metaschool Market fork repository or use "https://github.com/oceanprotocol/market.git" if you want to deploy the standard image of Metaschool Market.
